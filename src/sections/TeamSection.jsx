...
const TeamSection = () => {
    ...
    return (
        <div className="relative flex w-full h-full justify-center py-10">
            <Swiper
                modules={[Navigation]}
                slidesPerView="auto"
                spaceBetween={30}
                ...
                className="w-full h-[450px] md:w-[80%] relative"
            >
                    ...
                    <SwiperSlide key={index} className="w-full md:max-w-[350px]">
                        < div className="relative overflow-hidden shadow-xl rounded-sm group hover:h-full" >
                            ...
                            <div className="h-0 w-full bg-gradient-to-b from-transparent to-blue-900 overflow-hidden absolute bottom-0 flex flex-col items-center justify-center text-center transition-all duration-700 group-hover:h-full px-8 md:px-4">
                                <h2 className="font-semibold text-xl text-blue-50 md:mt-[90%]">{employee.name}</h2>
            ...
            <MdArrowBackIos className="swiper-button-prev translate-y-1/2 left-4 md:left-12 xl:left-32 text-blue-800 cursor-pointer hover:text-blue-300 duration-300" />
